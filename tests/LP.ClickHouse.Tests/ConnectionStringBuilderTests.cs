...
public class ConnectionStringBuilderTests
{
    ...
    {
        var options = new ClickHouseOptions { Host = "127.0.0.1", Port = 8123, Protocol = "http", Database = "analytics", Username = "default", Password = "secret", Compress = true, CheckCompressedHash = false, CommandTimeoutSeconds = 45 };
