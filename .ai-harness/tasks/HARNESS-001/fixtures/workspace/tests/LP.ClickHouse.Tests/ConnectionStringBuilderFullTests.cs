...
public class ConnectionStringBuilderFullTests
{
    ...
    public void Build_WithDefaultOptions_ShouldProduceValidConnectionString()
    {
        ...
        result.Should().NotContain("Client Name=");
    ...
    public void Build_WithCustomOptions_ShouldReflectAllValues()
    {
        ...
        result.Should().Contain("Client Name=Observability.Api");
    ...
    [Fact]
    public void Build_WithClientName_ShouldAppendClientNameSegment()
    {
        var options = new ClickHouseOptions { ClientName = "LP.ClickHouse.Tests" };
        var result = ClickHouseConnectionStringBuilder.Build(options);

        result.Should().Contain("Client Name=LP.ClickHouse.Tests;");
    }
